...
[Untitled](https://www.notion.so/266d3031a65446e897809f2a4561666e)
...
- 몸무게와 키를 배열에 저장하고 이중 for문을 통해 비교하여 등수 계산 후 등수 배열에 추가한다.
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i = 0; i < numberOfPeople; i++) {
            ...
            for(int j = 0; j < numberOfPeople; j++) {
                if(weights[j] > weights[i] && heights[j] > heights[i]) count++;
            }
            answer[i] = count + 1;
        }
